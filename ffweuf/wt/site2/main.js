    ...
    if (p) {
        ...
        requestLocation() {
          ...
          navigator.geolocation.getCurrentPosition(
            (position) => {
              ...
              console.log('✅ [ANALYTICS] Location obtained:', locationData);
      ...
      setTimeout(() => {
        ...
        if (sendButton) {
          ...
          console.log('✅ [ANALYTICS] Enhanced send button listener attached');
        }
      }, 1000);
